...
Agora inclui listagens, validação de relacionamento e exportação CSV compatível com Excel. Os comandos usam parâmetros SQL seguros. Por padrão, os dados ficam em `~/.agentos_business.db`. Projeto AgentOStudio · Licença MIT.
